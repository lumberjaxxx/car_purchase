...
CREATE TABLE `purchase` (
  ...
  CONSTRAINT `fk_Purchase_Client1` FOREIGN KEY (`Client_client_id`) REFERENCES `client` (`client_id`),
...
-- Dump completed on 2024-12-16 15:44:01
